...
Sudo
Définition
Sudo correspond à l'abréviation de Substitute User Do. La commande Sudo permet de lancer une commande en tant qu'administrateur.
...
Chown
Définition
La commande chown correspond à l'abréviation de change the owner et permet de changer le propriétaire d'un fichier ou d'un dossier.
...
Chmod
Définition
La commande chmod correspond à l'abréviation de change mode et permet de changer les permissions d'accès d'un fichier ou d'un répertoire.
